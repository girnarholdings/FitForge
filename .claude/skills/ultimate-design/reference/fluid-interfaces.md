# Fluid Interfaces — motion, gesture, material

The craft layer for anything a finger touches. Distilled from Apple's WWDC design talks — chiefly
*Designing Fluid Interfaces* (2018), *Designing Audio-Haptic Experiences*, *The Details of UI
Typography* (2020) and *Principles of Great Design* (2026) — and translated to the web platform
(CSS, Pointer Events, `requestAnimationFrame`, spring libraries such as Motion/Framer Motion).

**Load this before editing any interactive surface**, alongside `craft-floor.md`. Craft-floor is
the visual quality bar; this is the behavioural one. A surface can pass every rule in craft-floor
and still feel dead, and §1–§11 below are why.
